...
%token TVOID TCHAR TSHORT TINT TLNG TLNGLNG TUNSIGNED TFLOAT TDOUBLE CONST VOLATILE TBOOL TFAR INLINE STATIC EXTERN STATIC_ASSERT ALIGNOF ALIGNAS GENERIC
