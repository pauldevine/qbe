...
7. **Phase B'' narrower stores** — symmetric Phase B' gap for `Ostorew`/`Ostoreh`/`Ostoreb`.  Latent under both far-data and near-data; no consumer surfaced.  Track (g) in NEXT_SESSION_PROMPT.md.
