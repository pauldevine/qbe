 ...
 * v1.1 Using the "__TURBOC__" define Turbo C itself has,
 *		rather than the bogus "TURBOC" define.
 */
...
#ifdef __TURBOC__		/* v1.1 local prototypes */
void vbeep(void);
void setcolor (int color);
void set_mode (int m);
#ifdef BIOS
int set_25 (int lines);	/* set display to 25 line mode */
int set_43 (int lines);	/* set display to 43 line mode */
#else
void setraw (int r);
void set_25 (void);
void set_43 (void);
void send_setmode (int m);
#endif
#endif
...
void vbeep()		/* "Visual Bell" - reverse color flash */
{
